...
export default function UrlMetadataClient({ project }: UrlMetadataClientProps) {
  ...
  const handleExtract = async () => {
    ...
    try {
      ...
      const apiUrl = `https://url-metadata-api.brogee9o9.workers.dev/api/metadata?url=${encodedUrl}`;
          ...
          <div className={styles.demoCard}>
            ...
            <div className={styles.sampleApiBox}>
              ...
              <div className={styles.sampleApiUrl}>
                <code>{`<meta property="og:url" content="https://workerscando.com/api/metadata?url=https%3A%2F%2Ffreecodecamp.com" />`}</code>
              </div>
            </div>
          </div>
        </div>
