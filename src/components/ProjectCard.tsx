...
const getIconForTag = (tag: string) => {
  switch (tag.toLowerCase()) {
    ...
    case 'tools':
      return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>;
    case 'ai':
      return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M12 18v4"/><path d="M12 2v4"/></svg>;
    default:
...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  const icon = getIconForTag(project.tag);
    ...
    <article className={`${styles.card} ${isLive ? styles.cardLive : ''}`}>
      ...
      <div className={styles.meta}>
        ...
        {isLive ? (
          ...
          <span className={styles.action}>Soon</span>
        )}
      </div>
    </article>
  );
